...
Paperclip.options[:image_magick_path] = "/opt/local/bin" # FIXME: use config/initializers/paperclip.rb instead, see: http://github.com/thoughtbot/paperclip/issuesearch?state=open&q=VERSION#issue/117
